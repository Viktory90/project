...
<#list orderContactMechValueMaps as orderContactMechValueMap>
    ...
    <#if contactMech.contactMechTypeId == "POSTAL_ADDRESS">
        ...
        <fo:block font-weight="bold" font-family="Arial">${contactMechPurpose.get("description",locale)}:</fo:block>
        <fo:block text-indent="0.2in" font-family="Arial">
            <#if postalAddress?has_content>
...
<#if orderPaymentPreferences?has_content>
    <fo:block font-weight="bold" font-family="Arial">${uiLabelMap.AccountingPaymentInformation}:</fo:block>
...
<#if orderHeader.getString("orderTypeId") == "SALES_ORDER" && shipGroups?has_content>
    <fo:block font-weight="bold" font-family="Arial">${uiLabelMap.OrderShipmentInformation}:</fo:block>
...
<#if orderTerms?has_content && orderTerms.size() gt 0>
    <fo:block font-weight="bold" font-family="Arial">${uiLabelMap.OrderOrderTerms}:</fo:block>

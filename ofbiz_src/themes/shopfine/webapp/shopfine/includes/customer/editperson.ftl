...
<#if person?exists>
  ...
  &nbsp;<a href="javascript:document.editpersonform.submit()" class="btn btn-primary">${uiLabelMap.CommonSave}</a>
    <form id="editpersonform1" method="post" action="<@ofbizUrl>updatePerson</@ofbizUrl>" name="editpersonform" class="form-horizontal">    
							<h4>&nbsp;&nbsp;&nbsp;&nbsp;${uiLabelMap.PartyEditPersonalInformation}</h4>
<#else>
						<div class="titleHeader clearfix">
							<h3>${uiLabelMap.PartyAddNewPersonalInformation}</h3>
						</div><!--end titleHeader-->
  &nbsp;<a href='<@ofbizUrl>${donePage}</@ofbizUrl>' class="btn btn-small">${uiLabelMap.CommonGoBack}</a>
  &nbsp;<a href="javascript:document.editpersonform.submit()" class="btn btn-small">${uiLabelMap.CommonSave}</a>
    <form id="editpersonform2" method="post" action="<@ofbizUrl>createPerson/${donePage}</@ofbizUrl>" name="editpersonform" class="form-horizontal">
							<h4>&nbsp;&nbsp;&nbsp;&nbsp;${uiLabelMap.PartyAddNewPersonalInformation}</h4>
</#if>
<div>
  <p/>    
...
&nbsp;<a href='<@ofbizUrl>${donePage}</@ofbizUrl>' class="btn btn-small">${uiLabelMap.CommonGoBack}</a>
&nbsp;<a id="editpersonform3" href="javascript:document.editpersonform.submit()" class="btn btn-primary">${uiLabelMap.CommonSave}</a>

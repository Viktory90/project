      ...
      <div class="portal-column-config-title-bar">
        <ul class="unstyled spaced">
          <li class="margin_left_10">
            ...
            <a class="btn btn-mini btn-info" href="javascript:document.delColumn_${columnKey}.submit()" title="${delColumnHint}">${delColumnLabel}</a>
          </li>
          <li class="margin_left_10">
            ...
            <i class="icon-caret-right blue"></i>
            <a class="btn btn-mini btn-info" href="javascript:document.addPortlet_${columnKey}.submit()" title="${addPortletHint}">${addPortletLabel}</a>
          </li>
          <li class="margin_left_10">
            ...
            <i class="icon-caret-right blue"></i>
            <a class="btn btn-mini btn-info" href="javascript:document.setColumnSize_${columnKey}.submit()" title="${setColumnSizeHint}">${colWidthLabel}: ${width}</a>
          </li>
        </ul>
      </div>
      <br class="clear"/>
    ...
    <#if confMode == "true">
      <div class="portlet-config" id="PPCFG_${portletKey}">
        <div class="portlet-config-title-bar">
          <ul class="unstyled spaced">
            <li class="title" style="margin-left:10px">
            Portlet : [${portalPortletId}]</li>
            <li class="remove" style="margin-left:10px">
            ...
            <#if editAttribute == "true">
              <li class="edit" style="margin-left:10px">
            ...
            <#if prevColumnSeqId?has_content>
              <li class="move-left" style="margin-left:10px">
            ...
            <#if nextColumnSeqId?has_content>
              <li class="move-right" style="margin-left:10px">
            ...
            <#if prevPortletId?has_content>
              <li class="move-up" style="margin-left:10px">
            ...
            <#if nextPortletId?has_content>
              <li class="move-down" style="margin-left:10px">

    ...
    <div>${uiLabelMap.accCreateNew}</div>
		...
		<table>
			...
			<tr>
			    ...
			    <td align="right" style="min-width: 200px; padding-right: 15px;">
					${uiLabelMap.groupStatusId}
				</td>
				<td align="left">
					<div id="groupStatusId">
					</div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="right" style="min-width: 200px; padding-right: 15px;">
					${uiLabelMap.scheduledPostingDate}
				</td>
				<td align="left">
			...
			<tr>
				<td align="right">
					${uiLabelMap.inventoryItemId}
				</td>
				<td align="left">
					<input id="inventoryItemId"></input>
				</td>
				<td align="right" style="min-width: 200px; padding-right: 15px;">
					${uiLabelMap.physicalInventoryId}
				</td>
				<td align="left">
					<input id="physicalInventoryId"></input>
				</td>
			</tr>
			<tr>
				<td align="right">
					${uiLabelMap.receiptId}
				</td>
				<td align="left">
					<input id="receiptId"></input>
				</td>
				<td align="right" style="min-width: 200px; padding-right: 15px;">
					${uiLabelMap.theirAcctgTransId}
				</td>
				<td align="left">
					<input id="theirAcctgTransId"></input>
				</td>
			</tr>
			<tr>
				<td align="right">
					${uiLabelMap.voucherRef}
				</td>
				<td align="left">
					<input id="voucherRef"></input>
				</td>
				<td align="right" style="min-width: 200px; padding-right: 15px;">
					${uiLabelMap.voucherDate}
				</td>
				<td align="left">
			...
			<tr>
				<td align="right">
					${uiLabelMap.lastModifiedDate}
				</td>
				<td align="left">
					<div id="lastModifiedDate"></div>
				</td>
				<td align="right" style="min-width: 200px; padding-right: 15px;">
					${uiLabelMap.createdDate}
				</td>
				<td align="left">
			...
			<tr>
				...
				<td align="right" style="min-width: 200px; padding-right: 15px;">
					${uiLabelMap.finAccountTransId}
				</td>
				<td align="left">
					<input id="finAccountTransId">
					</input>
				</td>
			</tr>
			<tr>
...
<!--<div id='contextMenu'>
	<ul>
		<li><i class="icon-ok"></i>${StringUtil.wrapString(uiLabelMap.AccountingAcctgTrans)}</li>
		<li><i class="icon-ok"></i>${StringUtil.wrapString(uiLabelMap.AccountingExportAsPdf)}</li>
	</ul>
</div>-->
...
<script type="text/javascript">
	...
	/*	//Create context menu
	$("#contextMenu").jqxMenu({ width: 300, height: 	60, autoOpenPopup: false, mode: 'popup'});
	...
	$("#alterpopupWindow").jqxWindow({
		maxWidth: 1000, minWidth: 900, minHeight: 600, maxHeight: 1000, resizable: true,  isModal: true, autoOpen: false, cancelButton: $("#alterCancel"), modalOpacity: 0.7, theme:theme           
	});
	...
	$("#glJournalId").jqxDropDownList({ theme: theme, source: glJournalsData, displayMember: "description", valueMember: "glJournalId", selectedIndex: 1, width: '200', height: '25'});
	$("#groupStatusId").jqxDropDownList({ theme: theme, source: statusItemsData, displayMember: "description", valueMember: "statusId", selectedIndex: 1, width: '200', height: '25'});
	$("#finAccountTransId").jqxInput({width:195});
	...
	$('#inventoryItemId').jqxInput({width:195});
	$('#physicalInventoryId').jqxInput({width:195});
	$('#receiptId').jqxInput({width:195});
	$('#theirAcctgTransId').jqxInput({width:195});
	$('#voucherRef').jqxInput({width:195});
	$("#voucherDate").jqxDateTimeInput({width: '200px', height: '25px', formatString: 'dd-MM-yyyy hh:mm:ss'});
	$("#isPosted").jqxDropDownList({ theme: theme, source: isPostedData, displayMember: "description", valueMember: "isPosted", selectedIndex: 1, width: '200', height: '25'});
	$("#postedDate").jqxDateTimeInput({width: '200px', height: '25px', formatString: 'dd-MM-yyyy hh:mm:ss'});
	$("#lastModifiedDate").jqxDateTimeInput({width: '200px', height: '25px', formatString: 'dd-MM-yyyy hh:mm:ss'});
	$("#createdDate").jqxDateTimeInput({width: '200px', height: '25px', formatString: 'dd-MM-yyyy hh:mm:ss'});
	...
	$("#scheduledPostingDate").jqxDateTimeInput({width: '200px', height: '25px', formatString: 'dd-MM-yyyy hh:mm:ss'});
	...
	$("#alterSave").click(function () {
        ...
        row = { 
        		...
        		glJournalId:$('#glJournalId').val(),
        		groupStatusId:$('#groupStatusId').val(),
        		finAccountTransId:$('#finAccountTransId').val(),
        		inventoryItemId:$('#inventoryItemId').val(),
        		physicalInventoryId:$('physicalInventoryId').val(),
        		receiptId:$('#receiptId').val(),
        		theirAcctgTransId:$('#theirAcctgTransId').val(),
        		voucherRef:$('#voucherRef').val(),
        		voucherDate:$('#voucherDate').jqxDateTimeInput('getDate').getTime(),
        		isPosted:$('#isPosted').val(),
        		postedDate:$('#postedDate').jqxDateTimeInput('getDate').getTime(),
        		partyId:$('#partyId').val(),
        		...
        		scheduledPostingDate:$('#scheduledPostingDate').jqxDateTimeInput('getDate').getTime(),

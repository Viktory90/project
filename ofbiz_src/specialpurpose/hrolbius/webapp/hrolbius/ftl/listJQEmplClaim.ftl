...
<@jqGrid filtersimplemode="true" filterable="true" addrow="true"  addType="popup" addrefresh="true" alternativeAddPopup="alterpopupWindow" dataField=dataField columnlist=columnlist  clearfilteringbutton="true" 
		 url="jqxGeneralServicer?sname=JQgetListEmplClaims" otherParams="fullName:S-JQgetFullNameEmployee(inputValue{partyId})<outputValue>"
...
<script type="text/javascript">
	...
	$("#alterpopupWindow").jqxWindow({
        width: 1200, height : 1000,resizable: true,  isModal: true, autoOpen: false, cancelButton: $("#alterCancel"), modalOpacity: 0.7 ,initContent : function(){

...
<#assign columnlist="{ text: '${uiLabelMap.DAOrderId}', dataField: 'orderId', width: 150,
                      ...
                      { text: '${uiLabelMap.DACustomer}',filtertype: 'olbiusdropgrid', dataField: 'partyId', width: 500,
                      ...
                      { text: '${uiLabelMap.CommonAmount}', filterable: false, dataField: 'grandTotal', width: 250 , cellsrenderer:
					 	function(row, colum, value){
					 		var data = $('#jqxgrid').jqxGrid('getrowdata', row);
					 		console.log(data.currencyUom);

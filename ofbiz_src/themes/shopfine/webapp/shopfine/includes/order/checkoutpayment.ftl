...
<table width="100%">
  <tr valign="top">
    <td>
      &nbsp;<a href="javascript:submitForm(document.getElementById('checkoutInfoForm'), 'CS', '');"><button class="btn">${uiLabelMap.OrderBacktoShoppingCart}</button></a>
    </td>
    <td align="right">
      <a href="javascript:submitForm(document.getElementById('checkoutInfoForm'), 'DN', '');"><button class="btn btn-primary">${uiLabelMap.OrderContinueToFinalOrderReview}</button></a>
    </td>
  </tr>
</table>
...
public class ShipmentServices {
    ...
    public static Map<String, Object> updatePurchaseShipmentFromReceipt(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        try {
            ...
            for (GenericValue item: shipmentReceipts) {
                ...
                BigDecimal quantityQualityAssurance = item.getBigDecimal("quantityQualityAssurance");
    ...
    public static Map<String, Object> createInventoryTransfersForTransferShipment(DispatchContext dctx, Map<String, Object> context) {
    	...
    	try {
        	...
        	List<GenericValue> itemIssuances = delegator.findList("TransferItemIssuance", EntityCondition.makeCondition(UtilMisc.toMap("shipmentId", shipmentId)), null, null, null, false);
        	for (GenericValue itemIssuance : itemIssuances) {
//        		List<GenericValue> inventoryTransfers = delegator.findList("InventoryTransfer", EntityCondition.makeCondition(UtilMisc.toMap("transItemIssuanceId", itemIssuance.get("transItemIssuanceId"))), null, null, null, false);
...
//        		}
//        		
        		 Map<String, Object> tmpResult = dispatcher.runSync("createInventoryTransfer", UtilMisc.toMap("statusId", "IXF_COMPLETE", "xferQty", itemIssuance.getDouble("quantity"),
        				"inventoryItemId", itemIssuance.getString("inventoryItemId"), "facilityIdTo", shipment.getString("destinationFacilityId"),
						"itemIssuanceId", itemIssuance.getString("transItemIssuanceId"), "userLogin", userLogin));
        		if (ServiceUtil.isError(tmpResult)) {
        			return tmpResult;

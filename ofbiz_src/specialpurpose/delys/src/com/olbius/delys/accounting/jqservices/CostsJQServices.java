...
public class CostsJQServices {
    ...
    public static Map<String, Object> jqListCosts(DispatchContext ctx, Map<String, ? extends Object> context) {
    	...
    	try {
    		listIterator = delegator.find("CostComponentCalc", EntityCondition.makeCondition(listAllConditions,EntityJoinOperator.AND), null, null, listSortFields, opts);

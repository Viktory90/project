...
<script type="text/javascript">
	...
	<#assign columnlist="{ text: '${StringUtil.wrapString(uiLabelMap.ProductProductId)}', datafield: 'productId', width: 170, align: 'center', cellsrenderer:
			   ...
			   { text: '${uiLabelMap.thruDateOfPubich}', datafield: 'thruDate', width: 180, filtertype: 'range', cellsformat: 'dd/MM/yyyy', align: 'center', cellclassname: cellclassname, cellsrenderer:
			       function(row, colum, value){

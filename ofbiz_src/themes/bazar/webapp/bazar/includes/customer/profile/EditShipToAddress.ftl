  ...
  <fieldset>
    ...
    <#if shipToTelecomNumber?has_content>
      <div>
        ...
        <input type="text" name="countryCode" id="shipToCountryCode" class="required" value="${shipToTelecomNumber.countryCode?if_exists}" size="3" maxlength="3" style="width:30px"/>
        - <input type="text" name="areaCode" id="shipToAreaCode" class="required" value="${shipToTelecomNumber.areaCode?if_exists}" size="3" maxlength="3" style="width:30px"/>
        - <input type="text" name="contactNumber" id="shipToContactNumber" class="required" value="${contactNumber?default("${shipToTelecomNumber.contactNumber?if_exists}")}" size="6" maxlength="7" style="width:70px"/>
        - <input type="text" name="extension" value="${extension?default("${shipToExtension?if_exists}")}" size="3" maxlength="3" style="width:30px"/>
      </div>
    </#if>
    <div class="inline">
      <label for="setBillingPurposeForShipping" style="float:left; padding-right:10px; padding-top:3px">${uiLabelMap.EcommerceMyDefaultBillingAddress}</label>

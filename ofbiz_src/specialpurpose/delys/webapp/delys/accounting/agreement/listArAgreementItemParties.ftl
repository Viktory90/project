                     	 ...
                     	 cellsrenderer: function(row, colum, value)
                        {
                        	...
                        	for(i=0; i<dataPartyNameView.length;i++){
                        		if(dataPartyNameView[i].partyId==value){                        			
									return '<a style = \"margin-left: 10px\" href=' + '/delys/control/accArEditAgreementItemParty?partyId=' + dataPartyNameView[i].partyId + '&' + 'agreementId=' + data.agreementId + '&' + 'agreementItemSeqId=' + data.agreementItemSeqId + '>' + \"[\" + dataPartyNameView[i].partyId + \"]\" +  \" \" + dataPartyNameView[i].partyName + '</a>';
                    			}
                        	}

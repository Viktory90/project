...
<script type="text/javascript">
	...
	$("#alterSave").click(function () {
		...
		console.log($('#jqxwindowpartyIdkey').val());
...
<#assign columnlist="{ text: '${uiLabelMap.DAOrderId}', dataField: 'orderId',
						cellsrenderer: function (row, column, value) {
							var data = $('#jqxgrid').jqxGrid('getrowdata', row);
        					return '<a style = \"margin-left: 10px\" href=' + 'orderView?orderId=' + data.orderId + '>' +  data.orderId + '</a>'
    					}
					  },
 					  { text: '${uiLabelMap.DACreateDate}',filtertype: 'range', dataField: 'orderDate', cellsformat: 'dd/MM/yyyy'},
                      { text: '${uiLabelMap.DAOrderName}', dataField: 'orderName' },
                      { text: '${uiLabelMap.DACustomer}',filtertype: 'olbiusdropgrid', dataField: 'partyId',

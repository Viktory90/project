	                            ...
	                            <#list 0..sizeBrowse as i>
	                            	<tr>
	                            		<#if i == 0>
	                            			...
	                            			<td rowspan="${rowSpan}">${rule.paymentPartyId?if_exists}</td>
		...
		<form name="createSalesPolicyRule" method="post" action="<@ofbizUrl>createSalesPolicyRule</@ofbizUrl>" class="form-horizontal basic-custom-form form-small">
			...
			<div class="modal-body no-padding">
				<div class="row-fluid">
					...
					<div class="control-group">
						<label class="control-label" for="paymentPartyId">${uiLabelMap.DAPaymentPartyId} *:</label>
						<div class="controls">
							<div class="span12">
								<@htmlTemplate.lookupField name="paymentPartyId" id="paymentPartyId" value='${parameters.paymentPartyId?if_exists}' 

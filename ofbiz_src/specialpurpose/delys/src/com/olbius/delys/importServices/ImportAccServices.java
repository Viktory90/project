    	...
    	try {
    		...
    		if(!UtilValidate.isEmpty(listBL)){
    			for(GenericValue x : listBL){
    				...
    				List<GenericValue> listDetailCost = delegator.findList("CostAccBaseAndType", EntityCondition.makeCondition(UtilMisc.toMap("costAccountingTypeId", "COST_BILLOFLA", "organizationPartyId", party)), null, null, null, false);
...
//    						childDetail.ad
    ...
    public static Map<String, Object> updateCostBillAcc(DispatchContext ctx, Map<String, ? extends Object> context){
    	...
    	LocalDispatcher dispatcher = ctx.getDispatcher();
   	 	...
   	 	if(costBaseId != null){
	   	 	try {
				listOrderCostAccBase = delegator.findList("CostAccBase", EntityCondition.makeCondition(UtilMisc.toMap("organizationPartyId", (String)costBaseId.get("organizationPartyId"), "invoiceItemTypeId", invoiceItemTypeId, "costAccountingTypeId", "COST_ORDER")), null, null, null, false);
...
//tinh theo tieu thuc phan bo gia tri order				
    ...
    public static Map<String, Object> JQGetCostForOrder(DispatchContext ctx, Map<String, ? extends Object> context) throws ParseException {
    	...
    	String organizationPartyId = (String)param.get("organizationPartyId")[0];
    	SimpleDateFormat yearMonthDayFormat2 = new SimpleDateFormat("dd/MM/yyyy");

				...
				<form name="formFilter" action="<@ofbizUrl>category/~category_id=${productCategoryId}</@ofbizUrl>" method="post" style="margin:0px">
					...
					<div class="productFilter clearfix">
						...
						<div class="showItem inline pull-left">
						  	<button data-title="${uiLabelMap.ProductLowToHigh}" data-placement="top" data-toggle="tooltip" onclick="javascript:document.formFilter.sortAscending.value = 'Y';document.formFilter.submit();" class="btn<#if sortAscending?has_content && sortAscending.equals("Y")> btn-primary active</#if>"><i class="icon-sort-down"></i></button>
						  	<button data-title="${uiLabelMap.ProductHighToLow}" data-placement="top" data-toggle="tooltip" onclick="javascript:document.formFilter.sortAscending.value = 'N';document.formFilter.submit();" class="btn<#if sortAscending?has_content && sortAscending.equals("N")> btn-primary active</#if>"><i class="icon-sort-up"></i></button>
						</div>

...
//    protected String billFromVendorPartyId = null;
  //  protected String shipFromVendorPartyId = null;
    ...
    public void clearAllPromotionAdjustments() {
        ...
        while (cartItemIter.hasNext()) {
            ...
            if (checkItem != null && checkItem.getIsPromo()) {
            	...
            	if ((checkItem.getAssociatedOrderId() == null || "".equals(checkItem.getAssociatedOrderId().trim())) 
            			&& (checkItem.getAssociatedOrderItemSeqId() == null || "".equals(checkItem.getAssociatedOrderId().trim()))) {
    ...
    // TODOCHANGE add new method extend from "clearAllPromotionAdjustments" method
    ...
    public Map<String, Object> makeCartMap(LocalDispatcher dispatcher, boolean explodeItems) {
        ...
        String salesMethodChannelEnumId = (String) this.getAttribute("salesMethodChannelEnumId");
        if (salesMethodChannelEnumId != null) {
            result.put("salesMethodChannelEnumId", salesMethodChannelEnumId);
        }

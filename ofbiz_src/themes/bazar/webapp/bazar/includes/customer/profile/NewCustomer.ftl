                                        ...
                                        <div class="content">
                                            ...
                                            <table class="form">
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                        	<span class="required">*</span> ${uiLabelMap.PartyFirstName}:
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="lastName" id="lastName" class="required" value="${parameters.lastName?if_exists}" maxlength="30" /></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><input type="text" class="required validate-email" name="emailAddress" id="emailAddress" value="${parameters.emailAddress?if_exists}" maxlength="255" />
                                            ...
                                            <table class="form">
                                                <tbody>
                                                    <tr>          
                                                        ...
                                                        <td><input type="text" name="username" id="username" class="required" value="${parameters.username?if_exists}" maxlength="255" /></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><input type="password" name="password" id="password" class="required validate-password" value="${parameters.password?if_exists}" maxlength="16" /></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="password" name="passwordVerify" id="passwordVerify" class="required validate-passwordVerify" value="${parameters.passwordVerify?if_exists}" maxlength="16" />
                                            ...
                                            <table class="form">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" name="shipToCountryCode" id="shipToCountryCode" value="${parameters.shipToCountryCode?if_exists}" size="3" maxlength="3" style="width:30px" />
                                                            - <input type="text" name="shipToAreaCode" id="shipToAreaCode" value="${parameters.shipToAreaCode?if_exists}" size="3" maxlength="3" style="width:30px" />
                                                            - <input type="text" name="shipToContactNumber" id="shipToContactNumber" value="${contactNumber?default("${parameters.shipToContactNumber?if_exists}")}" size="6" maxlength="7" style="width:70px" />
                                                                     - <input type="text" name="shipToExtension" id="shipToExtension" value="${extension?default("${parameters.shipToExtension?if_exists}")}" size="3" maxlength="3" style="width:30px" />
                                            ...
                                            <table class="form">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="billToAddress1" id="billToAddress1" class="required" value="${parameters.billToAddress1?if_exists}" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td>${uiLabelMap.PartyAddressLine2}</td>
                                                        <td><input type="text" name="billToAddress2" id="billToAddress2" value="${parameters.billToAddress2?if_exists}" /></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="billToCity" id="billToCity" class="required" value="${parameters.billToCity?if_exists}" /></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="billToPostalCode" id="billToPostalCode" class="required" value="${parameters.billToPostalCode?if_exists}" maxlength="10" /></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><select name="billToCountryGeoId" id="billToCountryGeoId" class='required selectBox'>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" name="billToCountryCode" id="billToCountryCode" value="${parameters.billToCountryCode?if_exists}" size="3" maxlength="3" style="width:30px"/>
                                                            - <input type="text" name="billToAreaCode" id="billToAreaCode" value="${parameters.billToAreaCode?if_exists}" size="3" maxlength="3" style="width:30px"/>
                                                            - <input type="text" name="billToContactNumber" id="billToContactNumber" value="${contactNumber?default("${parameters.billToContactNumber?if_exists}")}" size="6" maxlength="7" style="width:70px"/>
                                                                     - <input type="text" name="billToExtension" id="billToExtension" value="${extension?default("${parameters.billToExtension?if_exists}")}" size="3" maxlength="3" style="width:30px"/>

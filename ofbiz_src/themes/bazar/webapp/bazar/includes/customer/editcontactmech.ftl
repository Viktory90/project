...
<#else>
  ...
  <#if contactMechTypeId?exists>
    <#if !contactMech?exists>
      <h2>${uiLabelMap.PartyCreateNewContactInfo}</h2>
      <a href='<@ofbizUrl>checkoutoptions</@ofbizUrl>' class="button">${uiLabelMap.CommonGoBack}</a>
      <a href="javascript:document.getElementById('editcontactmechform').submit()" class="button">${uiLabelMap.CommonSave}</a>
      <table width="90%" border="0" cellpadding="2" cellspacing="0">
        ...
        <tr>
          ...
          <td>
            <table border="0" cellspacing="1">
                  ...
                  <td>
                      <form name="deletePartyContactMechPurpose_${partyContactMechPurpose.contactMechPurposeTypeId}" method="post" action="<@ofbizUrl>deletePartyContactMechPurpose</@ofbizUrl>">
                        <div>
                          ...
                          <a href='javascript:document.deletePartyContactMechPurpose_${partyContactMechPurpose.contactMechPurposeTypeId}.submit()' class='button' style="display:block; height:20px; margin-top:20px">
              ...
              <tr>
                <td>
                  <form method="post" action='<@ofbizUrl>createPartyContactMechPurpose</@ofbizUrl>' name='newpurposeform' style="margin-top:auto; margin-bottom:auto; padding:12px 0">
                    <div>
                    <input type="hidden" name="contactMechId" value="${contactMechId}"/>
                    <input type="hidden" name="useValues" value="true"/>
    ...
    <#if contactMechTypeId = "POSTAL_ADDRESS">
      ...
      <tr>   
        ...
        <td>&nbsp;</td>
        <td>
          <select name="countryGeoId" id="editcontactmechform_countryGeoId" style="width:400px">

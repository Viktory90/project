...
<p>${uiLabelMap.EmailVerifyHello} ${partyName.firstName?if_exists} ${partyName.lastName?if_exists} ${partyName.groupName?if_exists}!</p>
<p>${uiLabelMap.EmailVerifyContent1} ${contactList.contactListName} ${uiLabelMap.EmailVerifyContent2}</p>
<p>${uiLabelMap.EmailVerifyContent3}:</p>
...
<a href="${verifyUrl}">${uiLabelMap.EmailVerifyContent4}</a><br />
${uiLabelMap.EmailVerifyContent5} ${contactListPartyStatus.optInVerifyCode} <br />
</body>
</html>

...
public class GLAccountVarianceReasonJQServices {
    ...
    public static Map<String, Object> getVarianceReasonGlAccounts(DispatchContext ctx, Map<String, ? extends Object> context) {
    	...
    	try {
    		listIterator = delegator.find("VarianceReasonGlAccount", EntityCondition.makeCondition(listAllConditions,EntityJoinOperator.AND), null, null, listSortFields, opts);

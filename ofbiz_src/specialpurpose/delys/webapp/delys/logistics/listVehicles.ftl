...
<#assign dataField="[{ name: 'vehicleId', type: 'string'},
	...
	<#assign columnlist="
						   ...
						   { text: '${uiLabelMap.UnitCostVehicle}',  datafield: 'unitCost', width: 200, editable: true},
						   { text: '${uiLabelMap.currencyUomId}',  datafield: 'currencyUomId', minwidth: 120, editable: true},
						   { text: '${uiLabelMap.maxWeight}',  datafield: 'maxWeight', width: 120, editable: false},
						   { text: '${uiLabelMap.minWeight}',  datafield: 'minWeight', width: 120, editable: false},
						   ...
						   { text: '${uiLabelMap.fromDate}',  datafield: 'fromDate', width: 180, editable: false, filtertype: 'range', cellsformat: 'dd/MM/yyyy'},
						   { text: '${uiLabelMap.thruDate}',  datafield: 'thruDate', width: 180, editable: false, filtertype: 'range', cellsformat: 'dd/MM/yyyy'},
						   "/>

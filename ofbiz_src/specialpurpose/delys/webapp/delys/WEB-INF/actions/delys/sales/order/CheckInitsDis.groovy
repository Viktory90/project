...
productStores = EntityUtil.filterByDate(delegator.findByAnd("ProductStoreRoleDetail", ["partyId" : userLogin.partyId, roleTypeId : "SALES_ADMIN"], ["productStoreId", "storeName"], true), true);
currentStoreId = "NA";

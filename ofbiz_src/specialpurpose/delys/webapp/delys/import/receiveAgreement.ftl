...
// editor.jqxDropDownList({ autoDropDownHeight: true, source: list });
						...
						{ text: '${uiLabelMap.departureDate}', datafield: 'departureDate', editable: true, columntype: 'datetimeinput', width: '150px', cellsformat: 'd'},
						{ text: '${uiLabelMap.arrivalDate}', datafield: 'arrivalDate', editable: true,  columntype: 'datetimeinput', width: '150px', cellsformat: 'd'},

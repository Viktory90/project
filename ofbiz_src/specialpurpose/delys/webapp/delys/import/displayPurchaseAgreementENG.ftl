	        ...
	        <div class="widget-body">
				...
				<div style="margin-left: 5%">
					...
					<div class="span3 end-group-group">
						...
						<b> ${uiLabelMap.Account2}: ${listFinAccountFroms.get(0).finAccountCode}</b> </br>
					</div>
				</div></br>
				...
				<div class="span12">
					...
					<table id="sale-forecast-view" class="table table-striped table-bordered table-hover">
			            <thead>
			                <tr class="sf-product">
			                	<td>${uiLabelMap.ProductId2}</td>
			                	<td>${uiLabelMap.description2}</td>
			                	<td>${uiLabelMap.Unit2}</td>
			                	<td>${uiLabelMap.quantity2}</td>
			                	<td>${uiLabelMap.unitPrice2} (${currencyUomId})</td>
			                	<td>${uiLabelMap.GoodValue2} (${currencyUomId})</td>
			                	<td>${uiLabelMap.Remark2}</td>
			                </tr>
			            </thead>
			            <tbody>
			            	<#assign totalValue = 0>
			            	...
			            	<#list listProducts as item>
			            		...
			            		<#assign listUomToConvert = Static["com.olbius.delys.services.DelysServices"].getListUomToConvert(delegator, productId, productPackingUomId, product.quantityUomId)!>
			            		<#assign convertNumber = Static["com.olbius.delys.services.DelysServices"].getProductConvertNumber(delegator, convertNumber, productId, productPackingUomId, product.quantityUomId, listUomToConvert)!>
				...
				<div class="span12">
				${uiLabelMap.AgreementDocumentTermDetail2}. </br>

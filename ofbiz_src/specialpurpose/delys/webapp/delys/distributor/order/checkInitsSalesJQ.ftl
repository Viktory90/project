<#--
Copy from checkInitsDis.ftl file
-->
<style type="text/css">
	#statusbarjqxgridSO {
...
<div class="row-fluid">
	<div class="span6">
		<form class="form-horizontal basic-custom-form form-size-mini" id="initOrderEntry" name="initOrderEntry" method="post" action="<@ofbizUrl>initOrderEntrySales</@ofbizUrl>" style="display: block;">
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="span12">
						<input type="text" name="orderId" id="orderId" class="span12 input-small" style="width:208px" maxlength="20" value="${parameters.orderId?if_exists}">
					</div>
				</div>
			</div>
			<div class="control-group">
	  		...
	  		<div class="control-group">
				...
				<div class="controls">
					<div class="span12">
						<div id="desiredDeliveryDate2" name="desiredDeliveryDate2"></div>
						<#--
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="span12">
						...
						<input type="text" class="span12 input-small disabled" readonly="true" maxlength="20" value="${productStores[0].storeName?if_exists}" style="width: 130px;"/>
						<div class="control-group" style="display:inline-block">
							<label class="control-label required" for="currencyUomId" style="width: 120px !important; color:#393939">${uiLabelMap.DACurrencyUomId}</label>
							<div class="controls" style="margin-left:140px !important">
	...
	<div class="span6">
			<div style="position:relative">
				<div id="checkoutInfoLoader" style="overflow: hidden; position: absolute; display: none;" class="jqx-rc-all jqx-rc-all-olbius">
					<div style="z-index: 99999; left: 50%; top: 5%; position: relative; width: 100px; height: 33px; padding: 5px; font-family: verdana; font-size: 12px; color: #767676; border-color: #898989; border-width: 1px; border-style: solid; background: #f6f6f6; border-collapse: collapse;" class="jqx-rc-all jqx-rc-all-olbius jqx-fill-state-normal jqx-fill-state-normal-olbius">
...
<#assign columnlist="{ text: '${uiLabelMap.DAProductId}', dataField: 'productId', width: '180px', editable:false},
				 	...
				 	{ text: '${uiLabelMap.DAQuantity}', dataField: 'quantity', width: '180px', cellsalign: 'right', filterable:false, sortable:false, 
					 	cellsrenderer: function(row, column, value){
					 		var data = $('#jqxgridSO').jqxGrid('getrowdata', row);
...
<script type="text/javascript">
	$("#desiredDeliveryDate2").jqxDateTimeInput({width: '208px', height: '25px', allowNullDate: true, value: null, formatString: 'yyyy-MM-dd hh:mm:ss'});

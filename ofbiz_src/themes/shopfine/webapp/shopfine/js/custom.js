...
function changeBackgroundPattern() {
	...
	// backgrounds
	$('head')
	.append('<link rel="stylesheet" id="active-bg" href="/shopfine/css/backgrounds/'+get_cookie1+'.css">');
	...
	$(".switcher > .switcher-content > .pattern-switch").find('a').bind('click', function(e) {
		...
		$('head')
		.append('<link rel="stylesheet" id="active-bg" href="/shopfine/css/backgrounds/'+bgName+'.css">');
	});
}
...
function changeLayoutStyle() {
	...
	//layout
	$('head')
	.append('<link rel="stylesheet" id="active-bg" href="/shopfine/css/layout/'+get_cookie2+'.css">');
	$(".switcher > .switcher-content > .layout-switch").find('a').bind('click', function(e){
		...
		$('head')
		.append('<link rel="stylesheet" id="active-layout" href="/shopfine/css/layout/'+layoutName+'.css">');
...
function changeColorStyle() {
	...
	//layout
	$('head')
	.append('<link rel="stylesheet" id="active-bg" href="/shopfine/css/color/'+get_cookie3+'.css">');
	$(".switcher > .switcher-content > .color-switch").find('a').bind('click', function(e){
		...
		$('head')
		.append('<link rel="stylesheet" id="active-color" href="/shopfine/css/color/'+colorName+'.css">');

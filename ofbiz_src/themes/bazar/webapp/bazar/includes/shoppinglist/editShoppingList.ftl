    ...
    <div class="screenlet-body">
        <#if shoppingLists?has_content>
          <form name="selectShoppingList" method="post" action="<@ofbizUrl>editShoppingList</@ofbizUrl>">
            <select name="shoppingListId" class="selectBox" style="width:80%;">
...
<div class="screenlet">
    <div class="boxlink">
      <form name= "createCustRequestFromShoppingList" method= "post" action= "<@ofbizUrl>createCustRequestFromShoppingList</@ofbizUrl>" style="display:inline-block">
      ...
      <form name="createQuoteFromShoppingList" method="post" action="<@ofbizUrl>createQuoteFromShoppingList</@ofbizUrl>" style="display:inline-block">
        <input type="hidden" name="shoppingListId" value="${shoppingList.shoppingListId}"/>
        <a href='javascript:document.createQuoteFromShoppingList.submit()' class="button">${uiLabelMap.OrderCreateQuoteFromShoppingList}</a>
      </form>
      <a href="javascript:document.updateList.submit();" class="button" style="display:inline-block; height:17px">${uiLabelMap.CommonSave}</a>
    </div>
    ...
    <div class="screenlet-body">
        <form name="updateList" method="post" action="<@ofbizUrl>updateShoppingList</@ofbizUrl>">
            ...
            <table border="0" width="100%" cellspacing="10" cellpadding="0" class="re-style-table">
              <tr>
                <td><div class="tableheadtext">${uiLabelMap.EcommerceListName}</div></td>
                <td><input type="text" class="inputBox re-size-80" size="25" name="listName" value="${shoppingList.listName}" />
              </tr>
              <tr>
                <td><div class="tableheadtext">${uiLabelMap.CommonDescription}</div></td>
                <td><input type="text" class="inputBox re-size-80" size="70" name="description" value="${shoppingList.description?if_exists}" />
              </tr>
              <tr>
                <td><div class="tableheadtext">${uiLabelMap.OrderListType}</div></td>
                <td>
                  <select name="shoppingListTypeId" class="selectBox re-size-80">
              ...
              <tr>
                ...
                <td>
                  <select name="isPublic" class="selectBox re-size-80">
              ...
              <tr>
                ...
                <td>
                  <select name="isActive" class="selectBox re-size-80">
              ...
              <tr>
                ...
                <td>
                  <select name="parentShoppingListId" class="selectBox re-size-80">
...
<div class="cartdiv">
    ...
    <div class="screenlet-body" style="margin-top:10px">
        <form name="reorderinfo" method="post" action="<@ofbizUrl>updateShoppingList</@ofbizUrl>">
            <input type="hidden" name="shoppingListId" value="${shoppingList.shoppingListId}"/>
            <table class="margin10 re-style-table" width="100%" cellspacing="10" cellpadding="1" border="0">
              <tr>
              ...
              <tr>
                <td align="right" colspan="9">
                  <div style="padding-top:15px; text-align:center">
                    ...
                    <a href="<@ofbizUrl>editeftaccount?DONE_PAGE=editShoppingList</@ofbizUrl>" class="button" style="margin-left:3px">${uiLabelMap.EcommerceNewEFTAccount}</a>
                  </div>
                </td>
              </tr>
              <#if shoppingList.isActive?default("N") == "Y">
                <tr>
                  <td colspan="9">
                    ...
                    <div>
                      <table cellspacing="2" cellpadding="2" border="0" class="re-style-table">
                        <tr>
...
<div class="screenlet">
    ...
    <div class="screenlet-body">
        <table width="100%" cellspacing="0" cellpadding="1" border="0" class="re-style-table">
          <tr>
            ...
            <table width="100%" cellspacing="0" cellpadding="1" border="0" class="re-style-table">
            	<thead>
	              <tr>
	                ...
	                <td>
	                	<table class="re-top-4">
	                		<tr>
	                			<td nowrap="nowrap" align="center"><b>- ${uiLabelMap.EcommerceStartdate} -</b></td>
	                			<td nowrap="nowrap"><b>- ${uiLabelMap.EcommerceNbrOfDays} -</b></td>
	                		</tr>
	                		<tr>
	                			<td nowrap="nowrap"><b>- ${uiLabelMap.EcommerceNbrOfPersons} -</b></td>
                    ...
                    <td nowrap="nowrap" align="center">
                      <form method="post" action="<@ofbizUrl>updateShoppingListItem</@ofbizUrl>" name="listform_${shoppingListItem.shoppingListItemSeqId}" style="margin: 0;">
                        ...
                        <div>
                           ...
                           <table border="0" class="re-top-4">
                                <tr>
                                    <td width="1%">&nbsp;</td>
                                    <td>
                                    	<@htmlTemplate.renderDateTimeField event="" action="" name="reservStartStr" className="inputBox" alert="" title="Format: yyyy-MM-dd HH:mm:ss.SSS" value="${shoppingListItem.reservStart?if_exists}" size="15" maxlength="30" id="reservStartStr_${shoppingListItem.shoppingListItemSeqId}" dateType="date" shortDateInput=true timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown="" timeHourName="" classString="" hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName=""/>
                                	</td>
              ...
              <tr>
                ...
                <td><div>&nbsp;</div></td>
                <td><div>&nbsp;</div></td>
                <td nowrap="nowrap" align="right" style="border-top: 1px solid #CCC; font-weight:bold">
...
<div class="cartdiv">
    ...
    <div class="screenlet-body">
      <table width="100%" border="0" cellspacing="1" cellpadding="1" class="re-style-table">
        <tr>
    ...
    <div class="screenlet-body">
        <form name="addToShoppingList" method="post" action="<@ofbizUrl>addItemToShoppingList<#if requestAttributes._CURRENT_VIEW_?exists>/${requestAttributes._CURRENT_VIEW_}</#if></@ofbizUrl>">
          ...
          <#if reservStart?exists>
	          ...
	          <td><input type="text" class="inputBox" size="2" name="reservLength" value="${requestParameters.reservLength?default("")}" /></td>
          </tr>
          <tr>
	          <td>&nbsp;</td>
	          <td>&nbsp;</td>
	          ...
	          <td nowrap="nowrap"></#if> ${uiLabelMap.CommonQuantity} :</td>
	          <td><input type="text" class="inputBox" size="5" name="quantity" value="${requestParameters.quantity?default("1")}" /></td>
	          <td><input type="submit" class="button" value="${uiLabelMap.OrderAddToShoppingList}"/>
        </form>
    </div>
</div>

...
<#assign dataField="[{ name: 'invoiceId', type: 'string' },
					 ...
					 "/>
<#assign columnlist="{ text: '${uiLabelMap.FormFieldTitle_invoiceId}', filtertype:'input', width:100, datafield: 'invoiceId', cellsrenderer:
					 ...
					 { text: '${uiLabelMap.description}', filtertype:'input', width:150, datafield: 'description'},
...
<@jqGrid url="jqxGeneralServicer?sname=JQGetListAPInvoice" dataField=dataField columnlist=columnlist jqGridMinimumLibEnable="false" filterable="true" filtersimplemode="true" addrow="true" addType="popup"
		 ...
		 addColumns="invoiceId" showtoolbar="false" alternativeAddPopup="alterpopupWindow" id="jqxgrid" usecurrencyfunction="true"/>

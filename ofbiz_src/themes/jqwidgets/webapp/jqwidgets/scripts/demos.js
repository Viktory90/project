...
jQuery(document).ready( function() {
	...
	var elem = $(".jqx-popup-olbius input[id^='alterSave']");
    for(var x = 0; x < elem.length; x++){
	 ...
	 var elem2 = $(".jqx-popup-olbius input[id^='alterCancel']");
	 ...
	 var elem3 = $(".jqx-popup-olbius input[id^='alterCopy']");
	 for(x = 0; x < elem3.length; x++){
	    	var tmp = $(elem3[x]);
	    	if(tmp.length){
			  var value = tmp.val();
			  tmp.val("✈  " + value);

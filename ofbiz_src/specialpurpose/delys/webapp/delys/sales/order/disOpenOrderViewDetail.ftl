		...
		<div class="widget-box transparent" id="recent-box">
			<div class="widget-header">
				...
				<h4 class="lighter smaller" style="margin-top: 10px;">
            		...
            		${externalOrder?if_exists} &nbsp;<a href="<@ofbizUrl>order.pdf?orderId=${orderId}</@ofbizUrl>" target="_blank" data-rel="tooltip" title="${uiLabelMap.DAExportToPDF}" data-placement="bottom"><i class="fa-file-pdf-o"></i></a>
				</h4>
				</#if>

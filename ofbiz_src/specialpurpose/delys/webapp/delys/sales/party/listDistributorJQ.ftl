...
<@jqGrid url="jqxGeneralServicer?sname=JQGetListDistributor" dataField=dataField columnlist=columnlist filterable="true" clearfilteringbutton="true"
		 ...
		 addrow="${addrow}" createUrl="jqxGeneralServicer?sname=createPartyDistributor&jqaction=C" addrefresh="true" 
		 ...
		 />
<#--
	{ text: '${uiLabelMap.DAAddress}', datafield: 'address'},
	{ text: '${uiLabelMap.DAPhone}', datafield: 'phone'},
	{ text: '${uiLabelMap.DAEmail}', datafield: 'email'},
	{ text: '${uiLabelMap.DAWebsite}', datafield: 'website'},
	{ text: '${uiLabelMap.DACountry}', dataField: 'countryGeoId'},
	{ text: '${uiLabelMap.DAStateProvince}', datafield: 'stateProvinceGeoId'}, 
	{ text: '${uiLabelMap.DACounty}', datafield: 'countyGeoId'},
-->

...
public class EntitySalesCommission implements Serializable{
	/**
	 * 
	 */
	...
	private List<EntitySalesCommissionAdjustment> listSalesCommissionsAdj;
	...
	public List<EntitySalesCommissionAdjustment> getListSalesCommissionsAdj() {
		return listSalesCommissionsAdj;
	}
	public void setListSalesCommissionsAdj(
			List<EntitySalesCommissionAdjustment> listSalesCommissionsAdj) {

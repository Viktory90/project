package com.olbius.jackrabbit.client.api.image;
...
import com.olbius.jackrabbit.client.api.image.JackrabbitImageTransform;
...
public class JackrabbitScaleImage {
	...
	public static Map<String, Object> scaleImageInAllSize(Map<String, ? extends Object> context, String path, Session session) throws IllegalArgumentException, ImagingOpException, IOException, JDOMException, RepositoryException, ParseException {

		OlbiusNodeFactory factory = new OlbiusNodeFactory();
		
		OlbiusNode olbiusNode = factory.newInstance(session);
			...
			for (Map.Entry<String, Map<String, String>> entry : imgPropertyMap.entrySet()) {
				...
				if (resultScaleImgMap.containsKey("responseMessage") && resultScaleImgMap.get("responseMessage").equals("success")) {
					...
					if (ScaleImage.sizeTypeList.contains(sizeType)) {
						imgUrlMap.put(sizeType, JcrClientProvider.WEB_DAV_URI.concat(JcrClientProvider.WSP_DEFAULT).concat(imageUrl));
					}
				} 
			} 

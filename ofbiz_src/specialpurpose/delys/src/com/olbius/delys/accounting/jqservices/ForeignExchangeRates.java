...
public class ForeignExchangeRates {
    ...
    public static Map<String, Object> jqGetListConversions(DispatchContext ctx, Map<String, ? extends Object> context) {
    	...
    	try {
    		listIterator = delegator.find("UomConversionDated", EntityCondition.makeCondition(listAllConditions,EntityJoinOperator.AND), null, null, listSortFields, opts);

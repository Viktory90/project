...
public class CheckOutHelperDis {
    ...
    // TODOCHANGE copy form createOrder method in com.olbius.delys.order.CheckOutHelper.createOrder(GenericValue, String, String, List<GenericValue>, boolean, String, String)

...
<script type="text/javascript">
	var quotationStatusData = new Array();
	<#list quotationStatusList as quotationStatus>
		...
		var row = {};
		row['statusId'] = '${quotationStatus.statusId}';
		row['description'] = "${description}";
		row['descriptionLo'] = '${descriptionLo}';
		quotationStatusData[${quotationStatus_index}] = row;
	</#list>
	
	var salesMethodChannelData = new Array();
	<#list salesMethodChannels as salesChannel>
		var row = {};
		row['enumId'] = "${salesChannel.enumId}";
		row['description'] = "${StringUtil.wrapString(salesChannel.get("description", locale))}";
		salesMethodChannelData[${salesChannel_index}] = row;
	</#list>
...
<#assign columnlist="{text: '${uiLabelMap.DAQuotationId}', dataField: 'productQuotationId', editable:false, width: '150px', 
						...
						{text: '${uiLabelMap.DAPartyApply}', dataField: 'partyApplies', width: '150px'}, 

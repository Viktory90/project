...
<div id="screenlet_1" class="widget-box transparent no-bottom-border">
	<div class="widget-header widget-header-blue widget-header-flat wi1dget-header-large">
		<h4>
			${uiLabelMap.PageTitleCheckJobRequest}
		</h4>
		<br class="clear"/>
	</div>
	<div class="widget-body">
		<div class="widget-body-inner" id="screenlet_1_col">
			<form name="EditJobRequest" onsubmit="javascript:submitFormDisableSubmits(this)" class="basic-form form-horizontal" id="EditJobRequest" action="<@ofbizUrl>checkJobRequest</@ofbizUrl>" method="post">
    			<div class="row-fluid">
  					...
  					<div class="control-group no-left-margin">
  						...
  						<div class="controls">
							...
							<#list checkStatusList as status>
  					...
  					<input type="hidden" name = "notiToId" value="${notiToId?if_exists}"/>
				</div>
			</form>
		</div>
	</div>

  ...
  <fieldset>
    ...
    <#if billToTelecomNumber?has_content>
      <div>
        ...
        <input type="text" name="countryCode" id="billToCountryCode" class="required" value="${billToTelecomNumber.countryCode?if_exists}" size="3" maxlength="3" style="width:30px" />
        - <input type="text" name="areaCode" id="billToAreaCode" class="required" value="${billToTelecomNumber.areaCode?if_exists}" size="3" maxlength="3" style="width:30px" />
        - <input type="text" name="contactNumber" id="billToContactNumber" class="required" value="${contactNumber?default("${billToTelecomNumber.contactNumber?if_exists}")}" size="6" maxlength="7" style="width:70px" />
        - <input type="text" name="extension" value="${extension?default("${billToExtension?if_exists}")}" size="3" maxlength="3" style="width:30px" />
      </div>
    </#if>
    <div class="inline">
    	<label for="setShippingPurposeForBilling" style="float:left; padding-right:10px; padding-top:3px">${uiLabelMap.EcommerceMyDefaultShippingAddress}</label>

...
<#macro showUnavailableVarients>
  <#if unavailableVariants?exists>
	...
	<div class="product-info">
        <div class="left">
          <div class="image"> 
          	<a href="${productOriginalImageUrl}" title="${productContentWrapper.get("PRODUCT_NAME")?if_exists}" class="cloud-zoom colorbox" id='zoom1' rel="adjustX: 0, adjustY:0, tint:'#000000',tintOpacity:0.2, zoomWidth:360, position:'inside', showTitle:false">
          		<img src="${productLargeImageUrl}" title="#" alt="#" id="image" /><span id="zoom-image"><i class="zoom_bttn"></i> Zoom</span>
          	</a>
          </div>
          <div class="image-additional">
          	<a href="${productOriginalImageUrl}" title="#" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: '${productLargeImageUrl}' ">
          		<img src="${productSmallImageUrl}" width="62" title="#" alt="#" />
          	</a>
          	<#if productAdditionalImage1?string?has_content>
          	<a href="${productAdditionalImage1}" title="#" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: '${productAdditionalImage1_Large}' ">
          		<img src="${productAdditionalImage1_Small}" width="62" title="#" alt="#" />
          	</a>
          	</#if>
          	<#if productAdditionalImage2?string?has_content>
          	<a href="${productAdditionalImage2}" title="#" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: '${productAdditionalImage2_Large}' ">
          		<img src="${productAdditionalImage2_Small}" width="62" title="#" alt="#" />
          	</a>
          	</#if>
          	<#if productAdditionalImage3?string?has_content>
          	<a href="${productAdditionalImage3}" title="#" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: '${productAdditionalImage3_Large}' ">
          		<img src="${productAdditionalImage3_Small}" width="62" title="#" alt="#" />
          	</a>
          	</#if>
          	<#if productAdditionalImage4?string?has_content>
          	<a href="${productAdditionalImage4}" title="#" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: '${productAdditionalImage4_Large}' ">
          		<img src="${productAdditionalImage4_Small}" width="62" title="#" alt="#" />
          	</a>
          	</#if>
          </div>
        </div>
          ...
          <div class="cart" id="addItemForm">
            <div style="display:block;width:100%;">
	          ...
	          <div class="options" style="width:98.5%;display:${stylevariant}">
	          	...
	          	<#if product.isVirtual?if_exists?upper_case == "Y">
	          		<#if product.virtualVariantMethodEnum?if_exists == "VV_FEATURETREE" && featureLists?has_content>test
	                <#list featureLists as featureList>
	                    <#list featureList as feature>
	                        <#if feature_index == 0>
              ...
              <#if inStock>
               <#-- <#if product.requireAmount?default("N") == "Y">
                ...
                <#else>
                	<div>
	                  <div class="qty">
	                      	<strong>${uiLabelMap.CommonQuantity}:</strong>
	                      	<a href="javascript:void(0);" class="qtyBtn mines">-</a>
	                      	<input name="quantity" id="qty" class="w30" value="1" size="2" maxLength="2" type="text" <#if product.isVirtual!?upper_case == "Y">disabled="disabled"</#if> />
	                      	<a href="javascript:void(0);" class="qtyBtn plus">+</a>
	                      	<div class="clear"></div>
	                  </div>
	                  <input type="button" value="${uiLabelMap.OrderAddToCart}" id="addToCart" class="button" onclick="javascript:addItem();">
                    </div>
                ...
                <#else>
                  <#if productStore?exists>
                    <#if productStore.requireInventory?exists && productStore.requireInventory == "N">
                      ...
                      <a href="javascript:addItem()" id="addToCart" name="addToCart" class="button">${uiLabelMap.OrderAddToCart}</a>
                      <@showUnavailableVarients/>
                    <#else>
            ...
            <div style="padding-top:10px;">&nbsp;&nbsp;&nbsp;- ${uiLabelMap.BigshopOR} -&nbsp;&nbsp;&nbsp;
            	<a href="#" class="wishlist" style="display:none;">Add to Wish List</a>
              <a href="#" class="wishlist" onclick="document.getElementById('addToCompare2form').submit();">${uiLabelMap.ProductAddToCompare}</a></div>
              <form id="addToCompare2form" method="post" action="<@ofbizUrl secure="${request.isSecure()?string}">addToCompare</@ofbizUrl>" name="addToCompare2form">
...
if (typeof FB !== 'undefined') {
    FB.XFBML.parse(document.getElementById('fb-like-span'));
          ...
          <!-- AddThis Button END -->
          <div class="tags" style="display:none;"> <b>Tags:</b> <a href="#">Apple</a>, <a href="#">Mobile</a>, <a href="#">Latest</a> </div>
        </div>
      </div>
      <!-- Tabs Start -->
      <div id="tabs" class="htabs"> 
      	<a href="#tab-description">${uiLabelMap.BigShopEcommerceDescription}</a> 
      	<a href="#tab-review">${uiLabelMap.OrderCustomerReviews}</a>
      	<a style="display:none;" id="mrv" href="#tab-makereview">${uiLabelMap.BigshopProductMakeReview}</a> 
      </div>
    ...
    <div id="associated-products" class="box">
        <#-- also bought -->

...
<div id="deliveries-tab" class="tab-pane">
	...
	<@jqGrid filtersimplemode="true" id="jqxgrid" addrefresh="true" usecurrencyfunction="true" addType="popup" dataField=dataField columnlist=columnlist clearfilteringbutton="true" showtoolbar="true" addrow="true" filterable="true" alternativeAddPopup="alterpopupWindow" editable="true" 
		 ...
		 updateUrl="jqxGeneralServicer?sname=updateTransferDelivery&jqaction=U" editColumns="statusId" functionAfterAddRow="updateJqxgridProduct()"
		/>
</div>
...
<div id="alterpopupWindow">
	...
	<div style="overflow: scroll; height: 540px;">
		...
		<div class='row-fluid' style="margin-left: 50px">
			...
			<div class='span3'>
				<div id="transferIdDis" class="green-label">
					${transfer.transferId}
				</div>
			</div>
		</div>
		...
		<div class='row-fluid' style="margin-left: 50px">
			...
			<div class='span3'>
				<div id="destFacilityId" style="width: 200px" class="green-label">
		...
		<div class='row-fluid' style="margin-left: 50px">
			...
			<div class='span3'>
				<div id="createDate" style="width: 200px" class="green-label">
				</div>
			</div>
		</div>
		<div class='row-fluid' style="margin-left: 50px">
			...
			<div class='span3'>
				<div id="deliveryDate" style="width: 200px" class="green-label">
				</div>
			</div>
		</div>
		<div class='row-fluid'>
			<div class='span12'>
				<div style="margin-left: 50px"><#include "ListTransferItem.ftl" /></div>
			</div>
		</div>   
	</div>
	</div>
...
<script type="text/javascript">
	...
	$("#alterSave").click(function () {
		...
		var listTransferItems = new Array();
		for(var i = 0; i < selectedIndexs.length; i++){
			var data = $('#jqxgridProduct').jqxGrid('getrowdata', i);
			var map = {};

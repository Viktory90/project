...
<#assign columnlist="{text: '${uiLabelMap.DAProductPromoRegisterId}', dataField: 'productPromoRegisterId', width: '180px', 
              		...
              		"/>
<#assign tmpCreateUrl = ""/>
<#if security.hasPermission("REGPR_SUP_APPROVE", session) || security.hasPermission("REGPR_ASM_APPROVE", session) || security.hasPermission("REGPR_ROLE_APPROVE", session)>

 ...
 */
olbius.controller('DashboardController', function($window,$rootScope, $scope, $location, $controller, DashboardServices) {
	...
	// $scope.PromotionStore = function(){
	// PromotionStore.getPromotionStore().then(function(res){
	// for(var pro in res["promotions"]){
	// $scope.dataPromotionDetail.push(res["promotions"][pro]);
	// };
	// });
	// };
